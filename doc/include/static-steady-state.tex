...
\end{align}
Consequently, after the linear transformation of $\a{\mpower}$ in \equref{steady-fourier}, $\a{\mtemperature}$ also becomes a multivariate normal random variable:
\begin{align*}
