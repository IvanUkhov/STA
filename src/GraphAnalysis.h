...
class GraphAnalysis
{
	...
	static vector_t compute_asap(const task_vector_t &tasks, const vector_t &duration);
	static vector_t compute_alap(const task_vector_t &tasks, const vector_t &duration,
		double asap_duration);

	static double compute_asap_duration(const task_vector_t &tasks, const vector_t &asap,
